...
class TestGetSuperatomTable:
    def test_returns_dict(self):
        from cdxml_toolkit.superatom_table import get_superatom_table
    ...
    def test_case_insensitive(self):
        from cdxml_toolkit.superatom_table import lookup_smiles
...
class TestLookupMw:
    def test_tbu_mw(self):
        from cdxml_toolkit.superatom_table import lookup_mw
        mw = lookup_mw("tBu")
...
class TestGetAbbrevLabel:
    def test_simple_label(self):
        from cdxml_toolkit.superatom_table import get_abbrev_label
